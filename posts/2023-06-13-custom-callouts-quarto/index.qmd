...
description: A brief tutorial on implementing callout style layouts in Quarto for those with basic CSS/HTML skills like myself.
...
categories: 
  ...
  - CSS
image: "goal.png"
image-alt: "[Goal post icons created by nawicon - Flaticon](https://www.flaticon.com/free-icons/goal-post)"
execute:
  echo: false
engine: knitr
---
...
I'm also including a small icon here, following the blog post instructions by Desirée mentioned above. I got the icon from [Flaticon](https://www.flaticon.com/free-icons/goal-post). Depending on where you place the icon, you will have to adjust the file path inside the `url()` command.
