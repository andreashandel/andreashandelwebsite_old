...
plotly::plot_ly(d2, x = ~comm_score, y = ~crit_score, type = "scatter", text = ~paste('Restaurant: ', name))
plotly::plot_ly(d2, x = ~comm_score, y = ~dave_score, type = "scatter", text = ~paste('Restaurant: ', name))
plotly::plot_ly(d2, x = ~crit_score, y = ~dave_score, type = "scatter", text = ~paste('Restaurant: ', name))
```
